...
public class Order extends Entity {
	...
	public JSONObject toJSON() {
		...
		orderJson.put("orderDate", new SimpleDateFormat("yyyy-mm-dd'T'HH:ss'Z").format(orderDate));
		orderJson.put("period", period);
		orderJson.put("returnDate", new SimpleDateFormat("yyyy-mm-dd'T'HH:ss'Z").format(returnDate));
